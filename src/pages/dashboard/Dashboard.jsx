                    ...
                    React.createElement('div', { className: 'flex justify-between items-start mt-2 mb-2 flex-wrap gap-2' },
                        React.createElement('div', { className: 'flex-1 flex flex-col items-center' },
                            React.createElement('span', { 
                                ...
                                style: { backgroundColor: stripAlphaChannel(detailedData.StatusData.ExtLeft.Color) }
                        ...
                        React.createElement('div', { className: 'flex-1 flex flex-col items-center' },
                            React.createElement('span', { 
                                className: 'badge w-full text-center',
                                style: { backgroundColor: stripAlphaChannel(detailedData.StatusData.ExtRight.Color) }
                        ...
                        React.createElement('div', { className: 'flex-1 flex flex-col items-center' },
                            React.createElement('span', { 
                                className: 'badge w-full text-center',
                                style: { backgroundColor: stripAlphaChannel(detailedData.StatusData.IntLeft.Color) }
                        ...
                        React.createElement('div', { className: 'flex-1 flex flex-col items-center' },
                            React.createElement('span', { 
                                className: 'badge w-full text-center',
                                style: { backgroundColor: stripAlphaChannel(detailedData.StatusData.IntRight.Color) }
                        ...
                        React.createElement('div', { className: 'flex-1 flex flex-col items-center' },
                            React.createElement('span', { 
                                className: 'badge w-full text-center',
                                style: { backgroundColor: stripAlphaChannel(detailedData.StatusData.BusLoad.Color) }
